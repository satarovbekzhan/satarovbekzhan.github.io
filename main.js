...
info_button.addEventListener("click", e => { // Слушатель событий клика кнопки 'информация'
    let instruction = "1) Set the alphabet\n" + // Инсьрукция использования
                    "2) Fill the state matrix like 'newvalue direction nextstate' (ex: a>1)\n" +
                    "3) Input the variable into the tape\n" +
                    "4) Move the starting index\n" +
                    "5) Run the programm\n"
